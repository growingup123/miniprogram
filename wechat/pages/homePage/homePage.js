...
Page({
  data: {
    ...
    itemList: [
      ...
      },
      {
        ...
        },
        {
          ...
          src: "https://jbxqalipay.nanjingdata.cn/image/yishi.png",
          name: "医师执业注册",
          detail: "医师（执业医师、执业助理医师）执业注册"
        },
        {
            dataId: "https://jbxqalipay.nanjingdata.cn" + app.globalData.test + "/web/wechat/modules/workGuide/templates/alipayItemList.html?siteId=1&types=c&alipay=1&itemKey=2&itemSource=A&showTerrace=W",
            src: "https://jbxqalipay.nanjingdata.cn/image/weisheng.png",
            name: "公共场所卫生许可",
            detail: "不含公园、体育场馆、公共交通工具"
        }
        ]
      },
    ...
    specificZone: [
      {
        title: '企业服务',
        dataId: "https://jbxqalipay.nanjingdata.cn" + app.globalData.test + "/web/wechat/modules/workGuide/templates/alipayItemList.html?siteId=1&types=c&alipay=1&itemKey=2&itemSource=A&showTerrace=U",
        src: 'https://jbxqalipay.nanjingdata.cn/image/qiyefuwu.png',
        bindType: 'navigateTo'
      },
      {
        title: '劳动者港湾',
      ...
      {
        title: '新区办电一点通',
        dataId: '/pages/electric/electric',
        src: 'https://jbxqalipay.nanjingdata.cn/image/dianli.png',
        bindType: 'navigateTo'
      },
      {
        title: '大厂街道便民服务',
        dataId: '/pages/dachang/dachang',
        src: 'https://jbxqalipay.nanjingdata.cn/image/dachang.png',
        bindType: 'navigateTo'
      },
      {
        title: '婚姻',
      ...
      },
      {
        ...
        src: 'https://jbxqalipay.nanjingdata.cn/image/iteme.png',
        bindType: 'toWebView'
      },
      {
        title: '建行',
      ...
      {
        title: '工行',
        dataId: '/pages/gongHang/gongHang',
        src: 'https://jbxqalipay.nanjingdata.cn/image/gonghang.png',
        bindType: 'navigateTo'
      },
      {
        title: '虚拟养老院',
  ...
  navigateTo(e) {
    ...
    var toUrl = '';
    if (e.target.dataset.id.substr(0,1) != '/'){
      toUrl = escape(url + '&code=B')
      wx.navigateTo({
